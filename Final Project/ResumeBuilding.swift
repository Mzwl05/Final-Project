            ...
            NavigationStack {
                ZStack {
                    ...
                    VStack{
                        ...
                        NavigationLink(destination: Resume(name2: $name2, lastName: $lastName, phoneNumber:$phoneNumber, email:$email, address: $address)
                                       //
                        ) {
                            Text("Enter now")
                                .font(.title)
...
struct ResumeBuilding_Previews: PreviewProvider {
    static var previews: some View {
        ResumeBuilding(name2: .constant(""), lastName: .constant(""), phoneNumber: .constant(""), email: .constant(""), address: .constant(""))
    }
}
